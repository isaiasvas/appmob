                        ...
                        <ul class="nav nav-pills nav-fill p-1 bg-transparent" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link mb-0 px-0 py-1 active " data-bs-toggle="tab" href="javascript:;"
                                    ...
                                    <span class="ms-1"><?php echo e(__('Visão Geral')); ?></span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link mb-0 px-0 py-1 " data-bs-toggle="tab" href="javascript:;" role="tab"
                                    ...
                                    <span class="ms-1"><?php echo e(__('Histórico')); ?></span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link mb-0 px-0 py-1 " data-bs-toggle="tab" href="javascript:;" role="tab"
                                    ...
                                    <span class="ms-1"><?php echo e(__('Casas')); ?></span>
                                </a>
                            </li>
                        </ul>
                    </div>
    ...
    <div class="container-fluid py-4">
        <div class="card">
            <div class="card-header pb-0 px-3">
                <h6 class="mb-0"><?php echo e(__('Informações do Produto')); ?></h6>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="product_categories" class="form-control-label"><?php echo e(__('Categoria')); ?></label>
                                <div class="<?php $__errorArgs = ['product_categories'];
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="product_sub_categories" class="form-control-label"><?php echo e(__('Subcategoria')); ?></label>
                                <div class="<?php $__errorArgs = ['product_sub_categories'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>border border-danger rounded-3 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                ...
                                <?php $__errorArgs = ['product_sub_categories'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="text-danger"><?php echo e($message); ?></div> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="product_price" class="form-control-label"><?php echo e(__('Preço do Imóvel')); ?></label>
                                <div class="<?php $__errorArgs = ['product_price'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>border border-danger rounded-3 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="product_location" class="form-control-label"><?php echo e(__('Endereço')); ?></label>
                                <div class="<?php $__errorArgs = ['product_location'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border border-danger rounded-3 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                    <input wire:model="product_location" class="form-control" type="text"
                                        placeholder="Digite o endereço" id="product_location">
                                </div>
                                <?php $__errorArgs = ['product_location'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="text-danger"><?php echo e($message); ?></div> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="product_images" class="form-control-label"><?php echo e(_('Imagens')); ?></label>
                                <div class="<?php $__errorArgs = ['product_images'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border border-danger rounded-3 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="d-flex justify-content-end">
                        <button type="submit"
                            class="btn bg-gradient-dark btn-md mt-4 mb-4"><?php echo e('Save Changes'); ?></button>
                    </div>
                </form>
...
</div><?php /**PATH /home/isaias/Desktop/app/resources/views/livewire/product/product-add.blade.php ENDPATH**/ ?>