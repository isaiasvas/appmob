                ...
                <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
                    <div class="card card-plain mt-8">
                        <div class="card-header pb-0 text-left bg-transparent">
                            <h3 class="font-weight-bolder text-info text-gradient"><?php echo e(__('Welcome back')); ?></h3>
                            <p class="mb-0"><?php echo e(__('Create a new acount')); ?><br></p>
                            <p class="mb-0"><?php echo e(__('OR Sign in with these credentials:')); ?></p>
                            <p class="mb-0"><?php echo e(__('Email ')); ?><b><?php echo e(__('admin@softui.com')); ?></b></p>
                            <p class="mb-0"><?php echo e(__('Password ')); ?><b><?php echo e(__('secret')); ?></b></p>
                        </div>
                        <div class="card-body">
                        ...
                        <div class="card-footer text-center pt-0 px-lg-2 px-1">
                            ...
                            <p class="mb-4 text-sm mx-auto">
                                ...
                                <a href="<?php echo e(route('sign-up')); ?>"
                                    class="text-info text-gradient font-weight-bold"><?php echo e(__('Sign up')); ?></a>
                            </p>
                        </div>
                    </div>
                </div>
...
<?php /**PATH /home/isaias/Desktop/app/resources/views/livewire/auth/login.blade.php ENDPATH**/ ?>