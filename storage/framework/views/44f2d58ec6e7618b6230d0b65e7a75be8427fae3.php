            ...
            <div class="card-body pt-4 p-3">
                ...
                <?php if($showDemoNotification): ?>
                    <div wire:model="showDemoNotification" class="mt-3  alert alert-primary alert-dismissible fade show"
                        ...
                        <span class="alert-text text-white">
                            <?php echo e(__('You are in a demo version, you can\'t update the profile.')); ?></span>
                ...
                <?php if($showSuccesNotification): ?>
                    <div wire:model="showSuccesNotification"
                        ...
                        <span
                            class="alert-text text-white"><?php echo e(__('Your profile information have been successfuly saved!')); ?></span>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="<?php $__errorArgs = ['user.email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>border border-danger rounded-3 <?php unset($message);
...
<?php /**PATH /home/isaias/Desktop/app/resources/views/livewire/laravel-examples/user-profile.blade.php ENDPATH**/ ?>