            ...
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link text-dark me-2 text-dark"
                        href=" <?php echo e(auth()->user() ? route('static-sign-up') : route('sign-up')); ?>">
...
<?php /**PATH /home/isaias/Desktop/app/resources/views/layouts/navbars/guest/login.blade.php ENDPATH**/ ?>