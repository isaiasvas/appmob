<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3"
    ...
    <div class="sidenav-header">
        ...
        <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="<?php echo e(route('dashboard')); ?>">
            ...
            <span class="ms-3 font-weight-bold">AppMob</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item mt-2">
                <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Imóveis</h6>
            </li>
            <li class="nav-item">
                <a class="nav-link <?php echo e(Route::currentRouteName() == 'adicionar-produto' ? 'active' : ''); ?>"
                    href="<?php echo e(route('adicionar-produto')); ?>">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo e(Route::currentRouteName() == 'tables' ? 'active' : ''); ?>"
                    href="<?php echo e(route('tables')); ?>">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo e(Route::currentRouteName() == 'billing' ? 'active' : ''); ?>"
                    href="<?php echo e(route('billing')); ?>">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo e(Route::currentRouteName() == 'rtl' ? 'active' : ''); ?>"
                    href="<?php echo e(route('rtl')); ?>">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo e(Route::currentRouteName() == 'profile' ? 'active' : ''); ?>"
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo e(route('sign-in')); ?>">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo e(route('static-sign-up')); ?>">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
...
<?php /**PATH /home/isaias/Desktop/app/resources/views/layouts/navbars/auth/sidebar.blade.php ENDPATH**/ ?>